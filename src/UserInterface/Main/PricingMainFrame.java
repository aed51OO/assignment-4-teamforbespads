...
import UserInterface.Main.SolutionShopping.SolutionShoppingCart;
...
public class PricingMainFrame extends javax.swing.JFrame {
    ...
    public PricingMainFrame() throws IOException {
        ...
        business = rp.initializeBusiness();
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        SolutionShoppingCart ssc = new SolutionShoppingCart(business, CardSequencePanel);
        CardSequencePanel.removeAll();
        CardSequencePanel.add("Solution Shopping Cart", ssc);
